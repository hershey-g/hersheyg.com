    ...
    <div className={`bg-[#162232] ${isModal ? "flex flex-col h-full" : "border border-[#1e3348] rounded-[14px] overflow-hidden"}`}>
      ...
      <div className="flex items-center gap-2 px-4 sm:px-5 py-3 sm:py-3.5 border-b border-[#1e3348] bg-black/15 flex-shrink-0">
        ...
        {isModal && onClose && (
          <button
            onClick={onClose}
            className="ml-2 w-10 h-10 flex items-center justify-center rounded-lg text-slate-300 hover:text-white hover:bg-white/10 transition-colors"
...
export default function IntakeAgent() {
  ...
  return (
    <>
      {/* Embedded section */}
      <section className="relative z-0 py-16 sm:py-32 sm:pb-16" ref={sectionRef}>
